...
export default function ErrorBanner({ children, onRetry, retryLabel = 'إعادة المحاولة' }) {
  ...
  return (
    <div className="mb-4 flex items-center justify-between gap-3 rounded-lg bg-rose-50 px-3 py-2 text-sm text-rose-600 dark:bg-rose-500/10 dark:text-rose-300">
      <span>{children}</span>
      {onRetry && (
