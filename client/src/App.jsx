...
function AppRoutes() {
  // نفس حالة الترخيص الحقيقية المستخدمة بأعلى المستوى بـ App() - هنا لازمة
  // حتى صفحة /activation (لما المالك يفتحها يدويًا من داخل التطبيق، مو من
  // شاشة القفل الإجبارية) تعرض العدّاد الحقيقي ورقم الجهاز الحقيقي، بدل
  // status={{status:'ok'}} المؤقتة السابقة.
      ...
      <Route
        ...
        element={
          <ProtectedRoute ownerOnly>
            <Activation status={status} onActivated={refresh} allowDismiss onDismiss={() => window.history.back()} />
          </ProtectedRoute>
        }
      />
      <Route
